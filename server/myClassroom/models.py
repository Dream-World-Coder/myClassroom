...
course_thumbnails:list = [
  "/images/courseThumbnails/1.png",
  "/images/courseThumbnails/2.png",
  "/images/courseThumbnails/3.png",
  "/images/courseThumbnails/4.png",
  "/images/courseThumbnails/5.png",
  "/images/courseThumbnails/6.png",
];
profile_images:list = [
...
class User():
  ...
  def get_course_data(self, course_id):
    course_id = int(course_id) - 1 # 1 based in client
    try:
      # uncomment if error needed for ui error handle testing
      # --- --- --- ---
